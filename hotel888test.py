...
class HilbertsHotel:
    ...
    def sort_rooms(self):
        ...
        return occupied_rooms  # คืนค่าเฉพาะหมายเลขห้องที่มีแขกเข้าพัก
    ...
    def timed_execution(self, func, *args, print_details=False):
        ...
        result = func(*args)
        if isinstance(result, np.ndarray):  # แสดงหมายเลขห้องที่มีแขกเข้าพัก
            print("หมายเลขห้องที่มีแขกอยู่:")
            for room in result:
                print(room, end=" ")  # พิมพ์ห้องแต่ละห้องแยกด้วย space
...
def main_menu():
    ...
    while True:
        ...
        if choice == '1':
            # แสดงเวลาที่ใช้ในการทำงานพร้อมแสดงหมายเลขห้องที่มีแขกอยู่
